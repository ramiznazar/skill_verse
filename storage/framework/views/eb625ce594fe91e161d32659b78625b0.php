                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $followUps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="timeline-item mb-4 p-3 border rounded shadow-sm">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <span
                                                    class="badge badge-<?php echo e($fu->status === 'interested' ? 'info' : ($fu->status === 'not_interested' ? 'dark' : ($fu->status === 'converted' ? 'success' : ($fu->status === 'lost' ? 'danger' : 'secondary')))); ?>">
                                            ...
                                            <div class="mt-2">
                                                <span
                                                    class="badge badge-primary"><?php echo e(ucfirst(str_replace('_', ' ', $fu->contact_method))); ?></span>
                                            ...
                                            <div class="mt-2 d-flex">
                                                ...
                                                <form action="<?php echo e(route('lead-followups.destroy', [$lead->id, $fu->id])); ?>"
