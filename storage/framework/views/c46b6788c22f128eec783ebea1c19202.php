                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    ...
                                    <select name="referral_type" id="referral_type" class="form-control">
                                        ...
                                        <option value="ads"      <?php echo e(old('referral_type', $admission->referral_type) == 'ads' ? 'selected' : ''); ?>>Ads</option>
                                        <option value="referral" <?php echo e(old('referral_type', $admission->referral_type) == 'referral' ? 'selected' : ''); ?>>Referral</option>
                                        <option value="other"    <?php echo e(old('referral_type', $admission->referral_type) == 'other' ? 'selected' : ''); ?>>Other</option>
                                    </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <select id="installment_count" name="installment_count" class="form-control">
                                            <option value="2" <?php echo e((int) old('installment_count', $preCount ?? 3) === 2 ? 'selected' : ''); ?>>2 Installments</option>
                                            <option value="3" <?php echo e((int) old('installment_count', $preCount ?? 3) === 3 ? 'selected' : ''); ?>>3 Installments</option>
                                        </select>
                                    </div>
                                </div>
