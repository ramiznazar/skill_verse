    ...
    <div id="main-content">
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right"> <a href="<?php echo e(route('admission.index')); ?>"
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="admission-form" action="<?php echo e(route('admission.update', $admission->id)); ?>"
                                method="POST" enctype="multipart/form-data"> <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?> 
                                <div class="row">
                                    <div class="col-md-6"> <label>Course</label> <select name="course_id" id="course_id"
                                        ...
                                        </select> <?php $__errorArgs = ['course_id'];
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6"> <label>Batch</label> <select name="batch_id" id="batch_id"
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select> <?php $__errorArgs = ['batch_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <hr class="mt-4">  <div class="row mt-2">
                                    <div class="col-md-4"> <label>Image</label> <input type="file" name="image"
                                            class="form-control" accept="image/*"> <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Full Name</label> <input type="text" name="name"
                                            value="<?php echo e(old('name', $admission->name)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>CNIC</label> <input type="text" name="cnic"
                                            value="<?php echo e(old('cnic', $admission->cnic)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Guardian Contact</label> <input type="text"
                                            ...
                                            class="form-control"> <?php $__errorArgs = ['guardian_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Date of Birth</label> <input type="date" name="dob"
                                            value="<?php echo e(old('dob', $admission->dob)); ?>" class="form-control"> <?php $__errorArgs = ['dob'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4"> <label>Email</label> <input type="email" name="email"
                                            value="<?php echo e(old('email', $admission->email)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Phone</label> <input type="text" name="phone"
                                            value="<?php echo e(old('phone', $admission->phone)); ?>" class="form-control">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Joining Date</label> <input type="date"
                                            name="joining_date" value="<?php echo e(old('joining_date', $admission->joining_date)); ?>"
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4"> <label>Status</label> <select name="student_status"
                                            ...
                                            <option value="completed"
                                                ...
                                                Completed</option>
                                        </select> <?php $__errorArgs = ['student_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Qualification</label> <select name="qualification"
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select> <?php $__errorArgs = ['qualification'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-6"> <label>Last Institute</label> <input type="text"
                                            ...
                                            class="form-control"> <?php $__errorArgs = ['last_institute'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                </div>  <div class="col-md-12" id="online-percentage-wrapper"
                                    style="display:none;">
                                    <div class="form-group"> <label>Online Fee Percentage (%)</label> <input
                                            ...
                                            to the teacher for online students.</small> <?php $__errorArgs = ['online_percentage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-12"> <label for="referral_type">Referral Type</label> <select
                                            ...
                                            <option value="other"
                                                ...
                                                Other</option>
                                        </select> <?php $__errorArgs = ['referral_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                </div>  <div class="row mt-3" id="referral_details_section"
                                    style="display:none;">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Source Contact #</label> <input type="number"
                                            ...
                                            class="form-control"> <?php $__errorArgs = ['referral_source_contact'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-4"> <label>Source Commission (%)</label> <input type="number"
                                            ...
                                            class="form-control"> <?php $__errorArgs = ['referral_source_commission'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group mt-3"> <label>Address</label>
                                    <textarea name="address" class="form-control" rows="3"><?php echo e(old('address', $admission->address)); ?></textarea> <?php $__errorArgs = ['address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="registration_fee" class="form-control"
                                                value="<?php echo e(old('registration_fee', $admission->registration_fee ?? 0)); ?>" min="0">
