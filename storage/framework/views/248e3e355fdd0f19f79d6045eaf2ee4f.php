...
<?php $__env->startSection('content'); ?>
    <div class="main-content">
        ...
        <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="<?php echo e(asset('assets/website/images/institute/19.jpg')); ?>">
                        ...
                        <div class="col-md-6">
                            <div class="video-popup">
                                <a href="https://www.youtube.com/watch?v=pW1uVUg5wXM" data-lightbox-gallery="youtube-video"
                                    title="Video">
                                    <img alt="" src="<?php echo e(asset('assets/website/images/institute/17.jpg')); ?>" class="img-responsive img-fullwidth">
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <?php $__currentLoopData = $upcomingEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <article class="post media-post clearfix pb-0 mb-10">
                                    <a href="#" class="post-thumb mr-20">
                                        <img alt="" src="<?php echo e(asset($event->image)); ?>" height="100">
                                    </a>
                                    <div class="post-right">
                                        ...
                                        <ul class="list-inline font-12 mb-5">
                                            ...
                                            <li class="pl-5">
                                                <i class="fa fa-map-marker mr-5"></i> <?php echo e($event->address); ?>
                                        ...
                                        <a class="text-theme-colored font-13"
                                            href="<?php echo e(route('event.detail', $event->id)); ?>">Read More →</a>
                                    </div>
                                </article>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/website/pages/about.blade.php ENDPATH**/ ?>