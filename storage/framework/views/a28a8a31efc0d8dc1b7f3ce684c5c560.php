...
<div id="main-content">
    <div class="block-header d-flex justify-content-between">
        <h2>Edit Course — <?php echo e($admission->name); ?></h2>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="body">
                <form method="POST" action="<?php echo e(route('admission.updateCourse', [$admission->id, $course->id])); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="course_id" id="course_id" class="form-control" disabled>
                            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $course->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <select name="batch_id" id="batch_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $batches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $batch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($batch->id); ?>" <?php echo e($pivot->batch_id == $batch->id ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="course_fee" id="course_fee" class="form-control"
                            value="<?php echo e($pivot->course_fee); ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="payment_type" class="form-control" id="payment_type">
                            <option value="full_fee" <?php echo e($pivot->payment_type === 'full_fee' ? 'selected' : ''); ?>>Full Fee</option>
                            <option value="installment" <?php echo e($pivot->payment_type === 'installment' ? 'selected' : ''); ?>>Installment</option>
                        </select>
                    </div>

                    
                    <div id="installment-section" style="<?php echo e($pivot->payment_type === 'installment' ? '' : 'display:none;'); ?>">
                        <div class="form-group">
                            <label>Installment Count</label>
                            <select name="installment_count" class="form-control" id="installment_count">
                                <option value="2" <?php echo e($pivot->installment_count == 2 ? 'selected' : ''); ?>>2 Installments</option>
                                <option value="3" <?php echo e($pivot->installment_count == 3 ? 'selected' : ''); ?>>3 Installments</option>
                            </select>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <label>Installment 1</label>
                                <input type="number" name="installment_1" class="form-control" value="<?php echo e($pivot->installment_1); ?>">
                            </div>
                            <div class="col-md-4">
                                <label>Installment 2</label>
                                <input type="number" name="installment_2" class="form-control" value="<?php echo e($pivot->installment_2); ?>">
                            </div>
                            <div class="col-md-4" id="installment_3_wrapper">
                                <label>Installment 3</label>
                                <input type="number" name="installment_3" class="form-control" value="<?php echo e($pivot->installment_3); ?>">
                            </div>
                        </div>
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" name="apply_additional_charges"
                                value="1" <?php echo e($pivot->apply_additional_charges ? 'checked' : ''); ?>>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/admin/pages/dashboard/admission/edit-new-course.blade.php ENDPATH**/ ?>