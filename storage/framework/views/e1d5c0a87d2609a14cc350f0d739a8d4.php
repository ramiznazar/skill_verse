    ...
    <div class="block-header">
        <div class="row clearfix">
            ...
            <div class="col-md-6 col-sm-12 text-right">
                <a href="<?php echo e(route('lead-followups.index',$lead->id)); ?>" class="btn btn-sm btn-primary">All Leads</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form id="follow-up-form" action="<?php echo e($action); ?>" method="POST" novalidate>
                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="contact_method" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $contactMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cm); ?>" <?php echo e(old('contact_method') === $cm ? 'selected' : ''); ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($st); ?>" <?php echo e(old('status') === $st ? 'selected' : ''); ?>>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input
                                            ...
                                            name="followed_at"
                                            class="form-control"
                                            value="<?php echo e(old('followed_at', now()->format('Y-m-d\TH:i'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="note" class="form-control" rows="4" placeholder="E.g., Asked to call next week, interested in weekend batch..."><?php echo e(old('note')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/admin/pages/dashboard/lead/follow-up/create.blade.php ENDPATH**/ ?>