                    ...
                    <div class="rev_slider" data-version="5.0">
                        <ul>
                            ...
                            <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                                ...
                                data-thumb="<?php echo e(asset('assets/website/images/bg/bg3.jpg')); ?>" data-rotate="0"
                                data-saveperformance="off" data-title="Slide 1" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="<?php echo e(asset('assets/website/images/bg/bg3.jpg')); ?>" alt=""
                                ...
                                <div class="tp-caption tp-resizeme" id="rs-1-layer-4" data-x="['left']"
                                    ...
                                    style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a
                                        ...
                                        href="<?php echo e(route('course')); ?>">View Details</a>
                                </div>
                            </li>
                            ...
                            <li data-index="rs-2" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                                data-easein="default" data-easeout="default" data-masterspeed="default"
                                data-thumb="<?php echo e(asset('assets/website/images/bg/bg2.jpg')); ?>" data-rotate="0"
                                data-saveperformance="off" data-title="Slide 2" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="<?php echo e(asset('assets/website/images/bg/bg2.jpg')); ?>" alt=""
                                ...
                                <div class="tp-caption tp-resizeme" id="rs-2-layer-4" data-x="['center']"
                                    ...
                                    style="z-index: 5; white-space: nowrap; letter-spacing:1px;"><a
                                        ...
                                        href="<?php echo e(route('contact')); ?>">Apply Now</a>
                                </div>
                            </li>
                            ...
                            <li data-index="rs-3" data-transition="slidingoverlayhorizontal" data-slotamount="default"
                                data-easein="default" data-easeout="default" data-masterspeed="default"
                                data-thumb="<?php echo e(asset('assets/website/images/bg/bg4.jpg')); ?>" data-rotate="0"
                                data-saveperformance="off" data-title="Slide 3" data-description="">
                                <!-- MAIN IMAGE -->
                                <img src="<?php echo e(asset('assets/website/images/bg/bg4.jpg')); ?>" alt=""
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portfolio-filter font-alt align-center">
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="#<?php echo e(Str::slug($category->title)); ?>"
                                        data-filter=".<?php echo e(Str::slug($category->title)); ?>"><?php echo e($category->title); ?></a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <!-- End Works Filter -->
                                ...
                                <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(is_array($item->images)): ?>
                                        <?php $__currentLoopData = $item->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="gallery-item <?php echo e($categoryClass); ?>">
                                                <div class="thumb">
                                                    <img class="img-fullwidth" src="<?php echo e(asset($image)); ?>"
                                                        alt="gallery-image"
                                                    ...
                                                    <div class="icons-holder">
                                                        <div class="icons-holder-inner">
                                                            <div
                                                                ...
                                                                <a data-lightbox="image" href="<?php echo e(asset($image)); ?>"><i
                                                    ...
                                                    <a class="hover-link" data-lightbox="image"
                                                        href="<?php echo e(asset($image)); ?>">View more</a>
                                                </div>
                                            </div>
                                            <!-- Portfolio Item End -->
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="item">
                                    <div class="testimonial-wrapper text-center">
                                        <div class="thumb"><img class="img-circle" alt=""
                                                src="<?php echo e($feedback->image); ?>"></div>
                                        <div class="content pt-10">
                                            <p class="font-15 text-white"><em><?php echo e($feedback->message); ?></em></p>
                                            <i class="fa fa-quote-right font-36 mt-10 text-gray-lightgray"></i>
                                            <h4 class="author text-theme-color-2 mb-0"><?php echo e($feedback->name); ?></h4>
                                            <h6 class="title text-white mt-0 mb-15"><?php echo e($feedback->designation); ?></h6>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="item">
                                        <article class="post clearfix bg-lighter">
                                                ...
                                                <div
                                                    ...
                                                    <ul>
                                                        <li class="font-16 text-white font-weight-600">
                                                            <?php echo e($date->format('d')); ?></li>
                                                        <li class="font-12 text-white text-uppercase">
                                                            <?php echo e($date->format('M')); ?></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="entry-content p-15 pt-10 pb-10">
                                                ...
                                                <p class="mt-5">
                                                    <?php echo e(Str::limit($blog->description, 120)); ?>

                                                    <a class="text-theme-color-2 font-12 ml-5"
                                                        href="<?php echo e(route('blog', $blog->id)); ?>">View Details</a>
                                                </p>
                                            </div>
                                        </article>
                                    </div>
...
<?php echo $__env->make('website.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/website/index.blade.php ENDPATH**/ ?>