                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $histories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge 
                                                    <?php if($history->status === 'paid'): ?> badge-success 
                                                    <?php elseif($history->status === 'balance'): ?> badge-info 
                                                    <?php else: ?> badge-warning <?php endif; ?>">
                                                    <?php echo e(ucfirst($history->status)); ?>

                                                </span>
                                            </td>
                                            <td><?php echo e(\Carbon\Carbon::create()->month($history->month)->format('F')); ?></td>
                                            <td><?php echo e($history->year); ?></td>
                                            <td><strong><?php echo e(number_format($history->amount)); ?> PKR</strong></td>
                                            <td><?php echo e($history->performedBy->name ?? '-'); ?></td>
                                            <td><?php echo e($history->performed_at ? $history->performed_at->format('Y-m-d H:i') : '-'); ?></td>
                                        </tr>
