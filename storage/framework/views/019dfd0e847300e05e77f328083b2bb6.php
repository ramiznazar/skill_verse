        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a href="<?php echo e(route('expense.index')); ?>" class="btn btn-sm btn-primary" title="">All Expense</a>
                </div>
            </div>
        </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form action="<?php echo e(route('expense.update', $expense->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" class="form-control"
                                                value="<?php echo e(old('date', $expense->date ? \Carbon\Carbon::parse($expense->date)->format('Y-m-d') : '')); ?>"
                                                required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    <label>Purpose</label>
                                    <textarea name="purpose" class="form-control" rows="3" required><?php echo e(old('purpose', $expense->purpose)); ?></textarea>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/admin/pages/dashboard/expense/update.blade.php ENDPATH**/ ?>