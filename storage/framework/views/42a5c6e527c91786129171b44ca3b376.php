...
<link rel="stylesheet" href="<?php echo e(asset('assets/admin/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/admin/vendor/chartist/css/chartist.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/admin/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css')); ?>">
...
<link rel="stylesheet" href="<?php echo e(asset('assets/admin/vendor/jquery-datatable/fixedeader/dataTables.fixedcolumns.bootstrap4.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('assets/admin/vendor/jquery-datatable/fixedeader/dataTables.fixedheader.bootstrap4.min.css')); ?>">
...
<div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-left">
                <div class="navbar-btn">
                    <a href="index.html"><img src="<?php echo e(asset('assets/admin/images/icon-light.svg')); ?>" alt="HexaBit Logo" class="img-fluid logo"></a>
                            ...
                            <ul class="dropdown-menu right_chat email">
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="<?php echo e(asset('assets/admin/images/xs/avatar4.jpg')); ?>" alt="">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="<?php echo e(asset('assets/admin/images/xs/avatar1.jpg')); ?>" alt="">
                                            <div class="media-body">
                                ...
                                <li>
                                    <a href="javascript:void(0);">
                                        <div class="media">
                                            <img class="media-object " src="<?php echo e(asset('assets/admin/images/xs/avatar5.jpg')); ?>" alt="">
                                            <div class="media-body">
    ...
    </nav><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/admin/layouts/header.blade.php ENDPATH**/ ?>