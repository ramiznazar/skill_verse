        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a href="<?php echo e(route('admin.dashboard.partners.create')); ?>" class="btn btn-sm btn-primary">Create New</a>
                </div>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td><?php echo e(number_format($partner->investment, 2)); ?></td>
                                                <td><?php echo e($partner->percentage); ?>%</td>
                                                <td class="actions">
                                                    <div class="d-flex align-items-center" style="column-gap: 5px;">
                                                        
                                                        <a href="<?php echo e(route('admin.dashboard.partners.edit', $partner->id)); ?>"
                                                        ...
                                                        <form action="<?php echo e(route('admin.dashboard.partners.destroy', $partner->id)); ?>"
                                                            method="POST"
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/admin/pages/dashboard/partners/index.blade.php ENDPATH**/ ?>