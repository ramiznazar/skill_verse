            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="basic-form" action="<?php echo e(route('course.store')); ?>" method="post"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="is_active" class="form-control">
                                                <option value="1" <?php echo e(old('is_active')); ?>>
                                                    Active
                                                </option>
                                                <option value="0" <?php echo e(old('is_active')); ?>>
                                                    Inactive
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="discount_offer" class="form-control">
                                                <option value="1" <?php echo e(old('discount_offer')); ?>>
                                                    Yes
                                                </option>
                                                <option value="0" <?php echo e(old('discount_offer')); ?> selected>
                                                    No
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="discount" class="form-control"
                                                value="<?php echo e(old('discount')); ?>" value="e.g 20%">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="interview_discount_per" class="form-control"
                                                    value="<?php echo e(old('interview_discount_per')); ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="interview_discount_amount"
                                                    class="form-control" value="<?php echo e(old('interview_discount_amount')); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\projects\codezy\zain-changes\codezy\resources\views/admin/pages/website/course/add-course.blade.php ENDPATH**/ ?>