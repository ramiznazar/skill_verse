                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <span>
                                                        <img src="<?php echo e(asset($course->image)); ?>" width="60" height="60"
                                                ...
                                                <td>
                                                    <span class="badge badge-primary">
                                                        <?php echo e($course->discount); ?>% → <?php echo e(intval($course->min_fee)); ?>

                                                    </span>
                                                </td>
                                                <td>
                                                    <?php if($course->interview_discount_per && $course->interview_discount_amount): ?>
                                                        <span class="badge badge-info" style="margin-top: 4px;">
                                                            <?php echo e($course->interview_discount_per); ?>% →
                                                            <?php echo e(intval($course->interview_discount_amount)); ?>
