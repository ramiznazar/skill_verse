...
@section('content')
                            ...
                            <div class="table-responsive mt-20">
                                <table class="table table-bordered">
                                    <tr>
                                        ...
                                        <td>{{ \Carbon\Carbon::parse($booking->testDay->test_date)->format('d M Y') }}</td>
                                    </tr>
                                    <tr>
                                        ...
                                        {{-- <td>{{ \Carbon\Carbon::parse($booking->testDay->test_start_time)->format('h:i A') }}</td> --}}
                                    </tr>
                                </table>
                            </div>
    ...
    <!-- Countdown Script -->
    <script>
        var testDateTime = new Date("{{ $date }} {{ $time }}").getTime();
