        ...
        <div class="block-header">
            <div class="row clearfix">
                ...
                <div class="col-md-6 col-sm-12 text-right">
                    <a href="{{ route('project.create') }}" class="btn btn-sm btn-primary" title="">Create New</a>
                </div>
            </div>
        </div>
        {{-- Store --}}
                                    ...
                                    <tbody>
                                        @foreach ($projects as $project)
                                            <tr>
                                                ...
                                                <td><span><img src="{{ asset($project->image) }}" width="100" alt=""></span></td>
                                                <td>{{ $project->title }}</td>
                                                <td><span class="text-info">{{ $project->link }}</span></td>
                                                <td>{{ $project->description }}</td>
                                                {{-- <td><span class="badge badge-success">Admit</span></td> --}}
                                                <td class="actions">
                                                    <div class="d-flex align-items-center gap-3">
                                                        <!-- Edit Button -->
                                                        <a href="{{route('project.edit',$project->id)}}" class="btn btn-sm btn-icon btn-pure btn-default on-default button-edit"
