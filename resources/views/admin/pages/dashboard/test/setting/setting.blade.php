                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="is_booking_open" class="form-control">
                                            <option value="1" {{ $settings->is_booking_open ? 'selected' : '' }}>Open
                                            </option>
                                            <option value="0" {{ !$settings->is_booking_open ? 'selected' : '' }}>
                                                Closed</option>
                                        </select>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="booking_start_date" class="form-control"
                                            value="{{ $settings->booking_start_date }}" required>
                                    </div>

                                    <div class="col-md-6">
                                        <label>Booking End Date</label>
                                        <input type="date" name="booking_end_date" class="form-control"
                                            value="{{ $settings->booking_end_date }}" required>
                                    </div>
                                </div>
